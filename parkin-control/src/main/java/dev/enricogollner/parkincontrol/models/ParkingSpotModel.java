package dev.enricogollner.parkincontrol.models;
...
public class ParkingSpotModel implements Serializable {
    ...
    private UUID id;  // identificador distribuído para arquiteturas distribuídas
    @Column(nullable = false, unique = true, length = 10)  // Campos únicos: não posso ter o 2 cadastros de uma mesma vaga - valores iguais não são permitidos
