...
public class ParkingSpotService {
    ...
    // Quando são métodos construtivos ou destrutivos, é interessante anotarmos eles com @Transactional
    // - para que caso algo der errado, ele garante o rollback, que volte tudo ao normal e não tenhamos dados quebrados
    @Transactional public ParkingSpotModel save(ParkingSpotModel parkingSpotModel) { return parkingSpotRepository.save(parkingSpotModel); }
    public boolean existsByLicensePlateCar(String licensePlateCar) { return parkingSpotRepository.existsByLicensePlateCar(licensePlateCar); }
